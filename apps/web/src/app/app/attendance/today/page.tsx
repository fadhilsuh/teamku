...
export default function Today(){
  ...
  async function checkin(){
    ...
    try{
      ...
      const result=await api<{checked_in_at:string;anomaly:string|null}>("/attendance/check-in",{method:"POST",headers:{"Idempotency-Key":crypto.randomUUID()},body:JSON.stringify({latitude:position.coords.latitude,longitude:position.coords.longitude,accuracy_meters:position.coords.accuracy,selfie_captured:true,agenda:[{title:agendaTitle.trim(),priority:"high",status:"planned"}]})},token());
